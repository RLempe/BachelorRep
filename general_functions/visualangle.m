...
% pix       = (2D) Größe des Objektes in Pixeln
% dist      = Abstand der Vp zum Monitor in cm
% res       = Auflösung des Bildschirms in Pixeln (Breite x Höhe, default: Full-HD)
% screen    = Größe des Bildschirms in cm (Breite x Höhe, default: 63.5 x 36 cm)
...
function [a,b]=visualangle(pix,dist,res,screen,va)
